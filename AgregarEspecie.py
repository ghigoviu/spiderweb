#Agregar especie a la base de datos
...
class AgregarEspecie(Frame):
    ...
    def __init__(self, container, controller, *args, **kwargs):
        ...
        lblNombreC = tkinter.Label(self, text="Nombre binomial", pady=2)
        ...
        lblNombreC.grid(row=1, column=0, pady= self.spcY)
